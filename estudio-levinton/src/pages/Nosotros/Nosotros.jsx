...
const TIMELINE = [
  { year: '1977', event: 'Raíces en PRENOVA',
    desc: 'Ricardo Levinton inicia la investigación biomimética inspirada en la estructura del fémur humano. El sistema PRENOVA de losas aligeradas llegaría a construir más de 1.000.000 m² globales.' },
  { year: '1984', event: 'Fundación del Estudio',
  ...
  { year: 'Hoy',  event: '+300 Obras Entregadas',
    desc: 'Cuatro décadas sin pausa. 300+ viviendas en los barrios más exclusivos, 30.000 m² en CABA, 645 hectáreas en Bariloche. Una obra que trasciende generaciones.' },
]
  ...
  return (
    <main className="nos-page">
        ...
        <div className="nos-team__grid container">
          <div className="nos-team__member">
            <div className="img-reveal nos-team__img">
              <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=80" alt="Arq. Sergio Levinton" />
            </div>
          ...
          <div className="nos-team__member">
            <div className="img-reveal nos-team__img">
              <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80" alt="Arq. Adriana Napoleone" />
            </div>
            <div className="nos-team__info">
              ...
              <p className="nos-team__bio">Arquitecta (UBA) y Licenciada en Artes Plásticas con especialización en Grabado (UNLP). Su manifiesto "La Multiplicación de los Planos" parte de la arquitectura como ADN constructor para generar espacios en 2D y 3D de radical economía formal.</p>
              <p className="nos-team__bio">Premio Adquisición Mención Arte Bancor 2022 (Museo Tamburini, Córdoba). Programa de Artistas Torcuato Di Tella 2011. Exposiciones en Nordelta Art Studio, Municipio de Tigre y Bahía Grande — el mismo territorio donde construye.</p>
      ...
      <section className="nos-cta">
        <div className="container">
          <div className="word-line"><span className="word-reveal nos-cta-title">¿PROYECTAMOS</span></div>
          <div className="word-line"><span className="word-reveal nos-cta-title nos-cta-title--dim">JUNTOS?</span></div>
          <Link to="/contacto" className="nos-cta-btn word-reveal">Contactar al estudio →</Link>
        </div>
      </section>
