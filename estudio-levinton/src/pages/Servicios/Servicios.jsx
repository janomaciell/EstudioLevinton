  ...
  return (
    <main className="sv-page">
      ...
      <section className="sv-cta">
        <div className="container">
          <div className="word-line"><span className="word-reveal sv-cta__title">¿LISTO PARA</span></div>
          <div className="word-line"><span className="word-reveal sv-cta__title sv-cta__title--dim">PROYECTAR?</span></div>
          <Link to="/contacto" className="sv-cta__btn word-reveal">Contactar al estudio →</Link>
        </div>
      </section>
