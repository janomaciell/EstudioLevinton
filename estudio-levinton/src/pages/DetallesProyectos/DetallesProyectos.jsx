...
export default function DetallesProyectos() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(lines, 
        { y: '110%' },
        { y: '0%', stagger: 0.1, duration: 1.0, ease: 'power4.out', delay: 3.1 }
      );
  ...
  return (
    <main className="dp-page">
      ...
      <section className="dp-contact">
        <div className="dp-contact__bg">
          {/* Usamos la última imagen de la galería o la principal como fondo del contacto */}
          <img src={project.gallery[project.gallery.length - 1] || project.img} alt="" />
          <div className="dp-contact__overlay" />
        </div>
        <div className="dp-contact__content container">
          <div className="dp-contact__header">
            <h2 className="dp-contact__title">¿TE INTERESA ESTA PROPIEDAD?</h2>
            <p className="dp-contact__sub">Dejanos tu consulta sobre <strong>{project.title}</strong> y un asesor se comunicará a la brevedad.</p>
          </div>
          ...
          <form className="dp-form" onSubmit={(e) => e.preventDefault()}>
            <div className="dp-form__row">
              ...
              <div className="dp-form__group">
                ...
                <input type="tel" id="phone" placeholder="Tu número" required />
              </div>
            </div>
            <div className="dp-form__group">
            ...
            <div className="dp-form__group">
              ...
              <textarea id="message" rows="4" placeholder={`Hola, me gustaría recibir más información sobre ${project.title}.`} required></textarea>
            </div>
            <button type="submit" className="dp-form__submit">Enviar Consulta</button>
          </form>
        </div>
      </section>
    </main>
