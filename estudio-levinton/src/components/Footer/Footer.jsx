    ...
    <footer className="footer">
      <div className="footer__top container">
        <div className="footer__brand">
          <span className="footer__logo">LEVINTON</span>
          <p className="footer__tagline">
            Diseño, construcción y supervisión integral de residencias de alta gama en zona norte de Buenos Aires.
          </p>
        </div>
      ...
      <div className="footer__bottom container">
        ...
        <span className="footer__copy">Zona Norte · Buenos Aires, Argentina</span>
      </div>
    </footer>
  )
}